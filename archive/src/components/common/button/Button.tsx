...
export const Button = (props: any) => {
  ...
  const onMouseMove = (e: React.SyntheticEvent) => {
    ...
    var x = (e as unknown as MouseEvent).clientX - rect.left; // x position within the element.
    var y = (e as unknown as MouseEvent).clientY - rect.top; // y position within the element.
