  ...
  return (
    <div className={className}>
      <div className={css["top"]}>
        ...
        <div className={css["link"]}>
          ...
          <p>
            <Tooltip
              arrow={true}
              visible={copied}
              content={<p>Copied hash to clipboard</p>}
            >
              <span
        ...
        <Modal
          image={"/assets/images/ipfs_illustration.png"}
          open={infoModal}
          close={() => setInfoModal(false)}
          title={`What is ${props.type}`}
        >
          <div className={css["modal-content"]}>
            {props.type === "IPFS" && (
              <>
                ...
                <p>
                  Help make devcon content less reliant on centralized platforms
                  that may not be accessible by users around the world.
                  Utilizing decentralized systems we can ensure that devcon
                  content is always available to those interested in learning
            ...
            {props.type === "Swarm" && (
              <>
                ...
                <p>
                  Swarm is a decentralized data storage and distribution
                  technology. Ready to power the next generation of
                ...
                <p>
                  Etherna provides a public accessible Swarm gateway to permits
                  everyone to access contents on the Swarm network in a easy
                  way. Built on this, Etherna offers a decentralized and
        ...
        >
          <ModalSlide>
            <div className={css["modal-content"]}>
              ...
              <p>
                To ensure that content persists on IPFS, and is not deleted
                during garbage collection, data can be pinned to one or more
                IPFS nodes. Pinning gives you control over disk space and data
                retention. You should use that control to pin any content you
                wish to help keep on IPFS indefinitely. The default behavior for
                IPFS is to pin files to your local IPFS node.
              </p>
          ...
          <ModalSlide>
            <div className={css["modal-content"]}>
              ...
              <p>
                Depending on how you use IPFS you might find it useful to use a
                remote pinning service. There are a number of commercial pinning
                services that make it easy for you to purchase pinning capacity
      ...
      {props.learnMore && (
        <div className={css["bottom"]}>
          <p>
            Help decentralize Devcon content by pinning this video on $
            {props.type}.
            <span
              className={css["learn-more"]}
              role="button"
              onClick={() => setIpfsPinModal(true)}
            >
              Learn More
            </span>
          </p>
