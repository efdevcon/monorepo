...
export default async function ComingSoonPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-2 py-8" style={{ backgroundColor: 'white' }}>
      <div className="flex-1 flex items-center justify-center">
        <pre 
          className="text-[0.4rem] lg:text-[0.55rem] leading-tight overflow-auto max-w-full"
          style={{ 
