...
const CryptoPaymentSection = forwardRef<HTMLDivElement, CryptoPaymentSectionProps>(
  (
    {
      cryptoPaymentQuests,
      isExpanded,
    ...
    return (
      <div id="crypto-payment-section" ref={ref} className="bg-[#d4f4dd] w-full">
        ...
        {/* Crypto Payment Quest List - Only show when section is expanded */}
        {isExpanded && (
          <div className="px-4 pb-4 space-y-3">
            {cryptoPaymentQuests.map((quest) => {
