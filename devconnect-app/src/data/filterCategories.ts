import { Briefcase, DollarSign, Microscope, Cpu, Users, Coffee, Utensils, Palette, ShoppingBag, LogIn, Target, Layers, Heart } from 'lucide-react'
...
export const filterCategories: FilterCategory[] = [
  ...
  { key: 'biotech', label: 'Onboarding L2', icon: Microscope, color: 'bg-purple-100 text-purple-700' },
  { key: 'hardware', label: 'Onboarding L3 & L2s', icon: Cpu, color: 'bg-orange-100 text-orange-700' },
  ...
  { key: 'art', label: 'Art Gallery', icon: Palette, color: 'bg-yellow-100 text-yellow-700' },
