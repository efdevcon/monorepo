...
export const districtsData: Districts = {
  "1": {
    ...
    "backgroundColor": "linear-gradient(90deg, rgb(170, 167, 255) 0%, rgb(246, 180, 14) 100%)",
    "logo": AiDistrictLogo.src
  },
  "2": {
    "name": "Collectibles",
    "layerName": "collectibles-district",
    "backgroundColor": "linear-gradient(90deg, rgb(255, 133, 166) 0%, rgb(238, 221, 51) 100%)",
    "logo": CollectiblesDistrictLogo.src
  },
  "3": {
    "name": "DeFi",
    "layerName": "defi-district",
    "backgroundColor": "linear-gradient(90deg, rgb(136, 85, 204) 0%, rgb(221, 102, 170) 100%)",
    "logo": DefiDistrictLogo.src
  },
  "4": {
    "name": "Gaming",
    "layerName": "gaming-district",
    "backgroundColor": "linear-gradient(90deg, rgb(136, 85, 204) 0%, rgb(238, 221, 51) 100%)",
    "logo": GamingDistrictLogo.src
  },
  "5": {
    "name": "Hardware & Wallets",
    "layerName": "hardware-wallets-district",
    "backgroundColor": "linear-gradient(90deg, rgb(116, 172, 223) 0%, rgb(238, 136, 34) 100%)",
    "logo": HardwareWalletsDistrictLogo.src
  },
  "6": {
    "name": "L2",
    "layerName": "l2-district",
    "backgroundColor": "linear-gradient(90deg, rgb(116, 172, 223) 0%, rgb(68, 221, 187) 100%)",
    "logo": L2DistrictLogo.src
  },
  "7": {
    "name": "Privacy",
    "layerName": "privacy-district",
    "backgroundColor": "linear-gradient(90deg, rgb(54, 54, 76) 0%, rgb(68, 221, 187) 100%)",
    "logo": PrivacyDistrictLogo.src
  },
  "8": {
    "name": "Social",
    "layerName": "social-district",
    "backgroundColor": "linear-gradient(90deg, rgb(255, 133, 166) 0%, rgb(170, 167, 255) 100%)",
