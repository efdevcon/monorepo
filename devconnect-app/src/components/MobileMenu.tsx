...
export default function Menu() {
  ...
  return (
    <>
      ...
      <div className="h-[72px] md:hidden pointer-events-none"></div>
      <nav
        className={cn(
          css['menu'],
          'md:hidden fixed bottom-0 left-0 right-0 z-50 flex justify-center items-center border-t border-gray-200 h-[calc(72px + max(0px, env(safe-area-inset-bottom)))]'
        )}
        style={{
