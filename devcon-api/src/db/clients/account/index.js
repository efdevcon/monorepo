...
const config = {
  ...
  "inlineSchemaHash": "536d84b4d8a3e4d678f5aedfdc318a135dfa466c0a41821c3f1657cac1cf0b0a",
  "copyEngine": true
}
...
path.join(process.cwd(), "src/db/clients/account/libquery_engine-debian-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "src/db/clients/account/schema.prisma")
