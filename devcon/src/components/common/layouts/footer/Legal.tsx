...
// Section header styled as the first content of a bullet `<li>`. The wrapping
// <li> still renders the disc marker so headers sit at the same indent as
// every other bullet in the document.
const SectionHeader = ({ children }: { children: React.ReactNode }) => (
  <span className="bold font-lg text-underline">{children}</span>
)
...
export const TermsOfService = () => {
  return (
    <div className={`${css['legal']} mb-8`}>
      ...
      <ul>
        <li>The Devcon 8 Privacy Notice;</li>
        <li>The Website Terms of Use;</li>
        <li>The Privacy Policy;</li>
        <li>The Cookie Policy;</li>
        <li>The Attendee Code of Conduct; and</li>
        <li>The Attendee Media Policy and Media Code of Conduct.</li>
      </ul>
      ...
      <ul>
        ...
        <li>
          This Agreement sets out the terms and conditions for purchasing tickets to, admittance to, attending, and/or
        ...
        <li>
          ...
          conditions explain the terms of purchasing tickets to, admittance to, attending, and otherwise participating
          in Devcon, including, but not limited to, prohibited activities, intellectual property rights, control of
          credentials issued by Us, how You and We may change or end the contract, and other important information.
        </li>
        <li>
          Our acceptance of Your order will take place when You receive a confirmation receipt that Your order has been
          successfully completed, at which point the Agreement will come into existence between You and Us.
        </li>
        <li>
          You may contact Us at support@devcon.org. If We have to contact You, We will do so by the email You have
          provided to Us.
        </li>

        <li>
          <SectionHeader>ADMITTANCE</SectionHeader>
        </li>
        <li>
          Your ticket entitles You to valid credentials issued by Us (the <b>&ldquo;Wristband&rdquo;</b>), which allow
          You admittance to Devcon. You are responsible for checking in at Devcon with proof of a valid ticket to
          receive Your Wristband. <b>No one will be admitted to Devcon without a Wristband.</b>
        </li>
        <li>
          Any and all other costs, arrangements, and legal requirements arising out of or relating to Your attendance
          of Devcon are solely Your responsibility. This includes, but is not limited to, passports, visas, entry
          permits, immigration permissions, security clearances, health requirements, travel documents, insurance,
          transport, accommodation, and all related needs and expenses. We do not provide immigration, visa, travel,
          tax, legal, or other professional advice. Any information, letter, acknowledgement, confirmation, or other
          document that We may provide in connection with Devcon is provided for administrative convenience only and
          does not guarantee that You will receive a visa, be allowed to board a flight or other transport, be allowed
          to enter the country in which Devcon is held, or be allowed to remain in that country. We shall bear no
          liability if You fail to make the appropriate arrangements, obtain the wrong visa or entry permission, are
          denied a visa, are refused boarding or entry, are removed or required to leave the country in which Devcon
          is held, or are otherwise unable to attend Devcon.
        </li>
        <li>
          We reserve the right, in Our sole discretion and without refund or other liability, to refuse admittance to,
          remove, expel, suspend, or ban anyone from present or future events:
        </li>
        ...
        <li>
          Who breaches the terms under this Agreement, including the rules and policies incorporated by reference
          herein;
        </li>
        <li>
          Who is determined by Us to have behaved in a manner that is harassing, threatening, abusive, insulting,
          intimidating, unsafe, disruptive, or unlawful, or that otherwise unacceptably impacts other
          participants&rsquo; ability to enjoy Devcon, including any conduct contrary to the Attendee Code of Conduct;
        </li>
        <li>
        ...
        <li>
          Who fails to comply with any instruction or requirement issued by Us, the venue, service providers, security
          personnel, or applicable authorities.
        </li>

        <li>
          <SectionHeader>AGE LIMITATIONS</SectionHeader>
        </li>
        <li>
          You must be 18 years of age or older to purchase a ticket to, attend, or participate in Devcon. By purchasing
          a ticket, You represent and warrant that You are 18 years of age or older, not barred from attending Devcon
          under the laws of the applicable jurisdiction, have the capacity to purchase a ticket, attend, and
          participate in Devcon, and have purchased a ticket for Your own attendance of and participation in Devcon.
        </li>
        <li>
          If You are under the age of 18 and wish to attend Devcon, please reach out to us at support@devcon.org before
          purchasing a ticket.
        </li>

        <li>
          <SectionHeader>WRISTBAND CONTROL</SectionHeader>
        </li>
        <li>
          <b>You must produce a valid Wristband to be admitted to and/or attend Devcon.</b> The Wristband must be worn
        ...
        <li>
          ...
          are personal revocable licences issued to You and shall at all times remain the sole property of Us. They do
          not confer any property right, entitlement, or guaranteed right of admission. Wristbands and other
        ...
        <li>
          Tickets, Wristbands, and other credentials may not be sold, resold, transferred, assigned, or otherwise made
          available to any other person without Our prior written permission. Any unauthorised transfer or attempted
          transfer may result in cancellation without refund.
        </li>

        <li>
          <SectionHeader>PROHIBITED ACTIVITIES</SectionHeader>
        </li>
        <li>
          ...
          conference.{' '}
          <b>
            As such, solicitation, sales, marketing, promotions, offers to sell, fundraising, token sales,
            announcements of ICOs, crowdsales, securities-related activities, financial promotions,
            &ldquo;suitcasing&rdquo;, and outboarding are all prohibited at Devcon.
          </b>{' '}
          Any activities including, but not limited to, marketing, promoting, offering to sell, selling, or soliciting
          investments, financial products, securities, or other regulated products or services are also strictly
          prohibited. &ldquo;Suitcasing&rdquo; refers to the practice of &ldquo;working the aisles&rdquo; of an event
          from a suitcase or briefcase, soliciting business from other attendees and participants.
        </li>
        <li>
          We reserve the right to deny entrance to or expel any person from Devcon who is determined by Us to have
          engaged in any unlawful, fraudulent, deceptive, non-compliant, or unauthorised activity at or in connection
          with Devcon. This includes, but is not limited to, any unlawful or non-compliant sale, marketing,
          fundraising, securities-related activity, financial promotion, investment activity, or other regulated
          activity.
        </li>

        <li>
          <SectionHeader>CHANGES TO THE EVENT</SectionHeader>
        </li>
        <li>
          ...
          sessions, speakers, moderators, venue, rooms, capacity, access rules, health or safety requirements, dates,
          and timings without notice and without refund, except where required by applicable law or expressly decided
          by Us.
        </li>
        <li>
          In addition to the requirements and prohibitions set forth in this Agreement, We may at Our sole discretion
          also exclude any person from purchasing a ticket. We also reserve the right to cancel, at Our sole
          discretion, any ticket upon refund of the fee paid to Us, provided, however, that if any ticket is cancelled
          for violating any of the terms set out in this Agreement, no refund will be made.
        </li>
        <li>
        ...
        <li>
          ...
          requirements relating to Devcon at any time, including for legal, regulatory, safety, security, operational,
          venue, community, or administrative reasons. Compliance with such policies, rules, guidelines, instructions,
          and requirements may be mandatory for the purchase of tickets to, admittance to, attendance of, or
        ...
        <li>
          ...
          case-by-case basis upon Your written request to support@devcon.org prior to the first day of Devcon. Any
          refunds are limited to a maximum amount of the price paid by You to Us.
        </li>
        <li>
          If a refund request is approved for a ticket paid for in cryptocurrency, the refund will be made in the same
          cryptocurrency and You will be responsible for paying the gas fees of the transaction of the refund. Such
          gas fees will be deducted from the refund amount.
        </li>
        <li>
          Please remember that cancelling Your ticket or sponsorship does not automatically cancel Your hotel, travel,
          visa, transport, or other arrangements. You are responsible for Your own hotel, travel, visa, transport,
          insurance, and other plans including, but not limited to, all costs, expenses, and fees associated with the
          cancellation, change, failure, or inability to use such arrangements.
        </li>

        <li>
          <SectionHeader>PRESENTATIONS, VIEWS AND MATERIALS</SectionHeader>
        </li>
        <li>
          ...
          supporters, exhibitors, and other participants are solely responsible for the content of any and all of their
          own presentations, publications, statements, activities, and related materials. The presence of any person,
          project, protocol, product, service, or other initiative at Devcon does not constitute Our endorsement,
          recommendation, approval, verification, or support of that person, project, protocol, product, service, or
          initiative.
        </li>
        <li>
          As Devcon is an educational conference, none of the presentations, publications, statements, activities, and
          related materials at or in connection with Devcon should be taken as investment, financial, trading, tax,
          legal, regulatory, accounting, or other professional advice, or as any offer, solicitation, recommendation,
          inducement, or promotion to buy, sell, subscribe for, hold, or otherwise deal in any investment, security,
          token, cryptoasset, financial product, or regulated product or service.
        </li>

        <li>
          <SectionHeader>PHOTOGRAPHY, RECORDING, LIVE STREAMING, AND VIDEO RECORDING</SectionHeader>
        </li>
        <li>
          We reserve the right to use images or videos taken at Devcon for present and future marketing materials,
          including images that may bear Your image or likeness. If You do not wish to appear in media images or videos
          at Devcon, please refer to the Attendee Media Policy.
        </li>
        <li>
          You may not record, stream, or otherwise broadcast audio or video of any and all sessions at Devcon. We allow
          cameras and photography at Devcon; however, professional video recording is strictly prohibited and anyone
          doing so may be immediately escorted out of the venue and may be asked to surrender his or her Wristband
          without refund. You are responsible for compliance with all applicable intellectual property, privacy and
        ...
        <li>
          For the avoidance of doubt, nothing in this Agreement shall be deemed to vest in You any legal or beneficial
          right in or to any intellectual property owned or licensed by Us or any of the Parties presenting at Devcon,
          all of which shall at all times remain the exclusive property of Us or the respective Parties presenting at
          Devcon.
        </li>

        <li>
          <SectionHeader>PRIVACY &amp; DATA PROTECTION</SectionHeader>
        </li>
        <li>
          We may process your name, contact data, and other personal data relating to your ticket purchase and
          attendance at Devcon (together, <b>&ldquo;Data&rdquo;</b>) for the purposes and in the course of Devcon.
        </li>
        <li>
        ...
        <li>
          ...
          providers (<b>&ldquo;Verification Providers&rdquo;</b>). Where you do so, the relevant Verification Provider
          may process your Data as an independent controller in connection with that verification process. That
          verification process takes place outside our systems and we do not control the Verification Provider&rsquo;s
          processing of your Data. For more information about how the relevant Verification Provider may process your
          Data, please review that provider&rsquo;s privacy notice.
        </li>
        <li>
        ...
        <li>
          ...
          your identity, confirm your ticket purchase, conduct appropriate checks, and prepare the letter. Where you
          do so, we may use third-party service providers to conduct identity verification, sanctions screening, or
          similar checks in connection with your request. Such providers may process your Data as our processors or as
        ...
        <li>
          ...
          holder of the ticket; (c) administration of ticket categories, discounts, and eligibility criteria; (d) fraud
        ...
        <li>
          You are under no obligation to provide us with your Data. However, if you do not do so, you may not be able
          to purchase a ticket, attend or otherwise participate in Devcon, access particular ticket types or discounts,
          or receive a ticket purchase confirmation letter. Should the provision of your Data be mandatory by law, we
          will inform you separately thereof.
        </li>
        <li>
          We process your Data for the performance of our contract with you insofar as such processing is necessary for
          ticket purchase, ticket administration, and attendance at Devcon, and otherwise on the basis of our
          overriding legitimate interest in achieving the purposes set out above, in accordance with Article 6(1)(b),
          Article 6(1)(f), and, where applicable, Article 6(1)(c) of the General Data Protection Regulation (
        ...
        <li>
          Third-party Verification Providers, such as SELF or other similar services, which may process personal data
          as independent controllers;
        </li>
        <li>Identity verification, sanctions screening, or similar service providers; and</li>
        <li>
          Courts, regulators, law enforcement authorities, or other third parties where such disclosure is required by
          applicable law, regulation, or legal process, or is necessary for the establishment, exercise, or defence of
          legal claims.
        </li>
        <li>
        ...
        <li>Under the applicable law, you have the right to (under the conditions set out in applicable law):</li>
        <li>
        ...
        <li>
          <SectionHeader>FORCE MAJEURE</SectionHeader>
          <p className="mt-2">
            We shall not be held responsible for any delay or failure in the performance of Our obligations under this
            Agreement to the extent that such delay or failure is caused by any event, circumstance, or cause beyond
            Our reasonable control, including, but not limited to, fire, flood, earthquakes, strike, civil,
            governmental, or military authority, acts of God, acts of terrorism, acts of war, disease, epidemics or
            pandemics, blackouts, insurrections, riots, civil disturbances, electrical disruptions, third-party
            injunctions, the unavailability of all or part of the venue, or any other event, circumstance, or cause
            that makes it illegal, impossible, or impracticable for Devcon, or any part of Devcon, to be held,
            operated, or made available as planned. For one or more of such reasons, We may postpone, reschedule,
            relocate, modify, restrict, or cancel any part of or the entirety of Devcon without liability on Our part.
            In the event any part of or the entirety of Devcon cannot be held, operated, or made available as planned,
            or is postponed, rescheduled, relocated, modified, restricted, or cancelled pursuant to this section, We
            shall not be liable to You for any incidental, consequential, special, direct, or indirect damages, costs,
            or losses incurred, including, but not limited to, transportation costs, accommodation costs, visa costs,
            insurance costs, or financial losses. We will review refund or fee transfer requests submitted in writing
            on a case-by-case basis.
          </p>
        </li>

        <li>
          <SectionHeader>DISCLAIMER &amp; LIMITATION OF LIABILITY</SectionHeader>
        </li>
        <li>
          ...
          implied warranties, so the above disclaimer may not apply to You in its entirety, but will apply to the
          maximum extent permitted by the applicable law.
        </li>
        <li>
          Except as required by law, neither We nor Our affiliates shall be liable for any direct, indirect, special,
          incidental, or consequential costs, damages, or losses arising directly or indirectly from Devcon or any
          other aspect related thereto or in connection with this Agreement.
        </li>
        <li>
          Our maximum aggregate liability for any claim in any way connected with or arising from Devcon or this
          Agreement, whether in contract, tort, or otherwise (including any negligent act or omission) shall be limited
          to the amount paid by You to Us under this Agreement. The foregoing does not affect any liability which
        ...
        <li>
          ...
          <p className="mt-2">
            ...
            to, during, or after Devcon, and You hereby release the Indemnitees from any such claims or injuries to
            the extent permissible by applicable law. This section shall survive the termination or expiration of this
            Agreement.
          </p>
        </li>

        <li>
          <SectionHeader>COMPLIANCE WITH LAWS</SectionHeader>
        </li>
        ...
        <li>
          ...
          ordinances, regulations, sanctions, export controls, immigration requirements, and other legal requirements
          that apply to You or to Your purchase of tickets to, attendance of, or participation in Devcon. You also
          agree to comply with any policies, instructions, or requirements issued from time to time by Us, the venue,
          service providers, security personnel, or applicable authorities.
        </li>
        <li>
          You agree that Your purchase of tickets to, attendance of, and participation in Devcon will not be for any
          unlawful purpose and will not violate, cause Us to violate, or assist in the violation of, any law, statute,
          ordinance, regulation, sanctions program, export control, anti-money laundering law, anti-bribery law,
          anti-corruption law, counter-terrorism financing law, immigration requirement, or other legal restriction
          applicable to You, Us, Devcon, the venue, payment providers, service providers, or the relevant transaction.
        </li>
        <li>
        ...
        <li>
          ...
          participation in Devcon. Failure or refusal to complete any such checks may result in refusal of admittance,
          expulsion, cancellation of Your ticket, or revocation of Your Wristband or other credentials without refund.
        </li>

        <li>
          <SectionHeader>WAIVER AND SEVERABILITY</SectionHeader>
        </li>
        <li>
          No waiver by Us of any term or condition set out in the Agreement shall be deemed a further or continuing
          waiver of such term or condition or a waiver of any other term or condition, and any failure of Us to assert
          a right or provision under the Agreement shall not constitute a waiver of such right or provision.
        </li>
        <li>
        ...
        <li>
          ...
          <p className="mt-2">
            This Agreement and all matters relating to Devcon shall be governed by and construed in accordance with
            the laws of Switzerland (excluding treaties or International Conventions such as the UN Convention on
            Contracts for the International Sale of Goods) without regard for conflicts of laws principles.
          </p>
        </li>
        ...
        <li>
          ...
          <p className="mt-2">
            ...
            date on which the Notice of Arbitration is submitted in accordance with these Rules. The number of
        ...
        <li>
          <SectionHeader>ENTIRE AGREEMENT</SectionHeader>
          <p className="mt-2">
            The Agreement, including the documents incorporated by reference, constitutes the sole and entire
            agreement between You and Us with respect to Your purchase of tickets to, admittance to, attendance of, or
            ...
            representation, covenant, warranty, undertaking, or indemnity by any person other than as expressly set
    ...
    <div className={`${css['legal']} mb-8`}>
      ...
      <ul>
        ...
        <li>
          ...
          so, we may use third-party service providers to conduct identity verification, sanctions screening, or
          similar checks in connection with your request. Such providers may process your Data as our processors or as
          independent controllers, depending on the relevant service and provider. Where a provider acts as an
          independent controller, its processing of your Data will be subject to its own privacy notice.
        </li>
