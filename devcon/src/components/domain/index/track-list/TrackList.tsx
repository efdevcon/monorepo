...
const Tracks = (props: Props) => {
  ...
  return (
    <div className={`${css['container']} text-white`} id="tracks">
          ...
          {tracks.map((track: any, i: number) => {
            ...
            return (
              <FlipCard key={track.id} className={className} to={track.url || undefined}>
                <div className="flex flex-col p-4 relative h-full select-none text-[rgb(48,53,75)]">
                ...
                <div className={cn(css['details'], 'flex flex-col justify-between text-[rgb(48,53,75)]')}>
                  <div className={css['title']}>{track.title}</div>
