...
export const CONSTELLATION_SPEAKERS: ConstellationSpeaker[] = [
  { id: 'vitalik', name: 'Vitalik Buterin', title: 'Co-Founder', company: 'Ethereum', color: '#6366f1', image: vitalikImg, event: devcon7, companyLogo: logoEthereumFoundation },
  { id: 'audrey', name: 'Audrey Tang', title: 'Digital Minister', company: 'Taiwan', color: '#8b5cf6', image: audreyImg, event: devcon7 },
  { id: 'danny', name: 'Danny Ryan', title: 'President', company: 'Etherealize', color: '#a855f7', image: dannyImg, event: devcon6, companyLogo: logoEtherealize },
  { id: 'aya', name: 'Aya Miyaguchi', title: 'Board Member', company: 'Ethereum Foundation', color: '#d946ef', image: ayaImg, event: devcon7, companyLogo: logoEthereumFoundation },
  { id: 'joseph', name: 'Joseph Lubin', title: 'Founder', company: 'ConsenSys', color: '#ec4899', image: josephImg, event: devcon5, companyLogo: logoConsensys },
  { id: 'hsiao', name: 'Hsiao-Wei Wang', title: 'Executive Director', company: 'Ethereum Foundation', color: '#f43f5e', image: hsiaoImg, event: devcon6, companyLogo: logoEthereumFoundation },
  { id: 'justin', name: 'Justin Drake', title: 'Researcher', company: 'Ethereum Foundation', color: '#6366f1', image: justinImg, event: devcon7, companyLogo: logoEthereumFoundation },
  { id: 'brewster', name: 'Brewster Kahle', title: 'Founder', company: 'Internet Archive', color: '#8b5cf6', image: brewsterImg, event: devcon6, companyLogo: logoInternetArchive },
  { id: 'stani', name: 'Stani Kulechov', title: 'Founder & CEO', company: 'Aave', color: '#f97316', image: staniImg, event: devcon7, companyLogo: logoAave },
  { id: 'sreeram', name: 'Sreeram Kannan', title: 'Founder', company: 'EigenCloud', color: '#06b6d4', image: sreeramImg, event: devcon6, companyLogo: logoEigencloud },
  { id: 'pooja', name: 'Pooja Ranjan', title: 'Project Manager', company: 'Ethereum Cat Herders', color: '#14b8a6', image: poojaImg, event: devcon7, companyLogo: logoEthereumCatHerders },
