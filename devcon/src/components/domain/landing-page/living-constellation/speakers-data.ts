...
export const CONSTELLATION_SPEAKERS: ConstellationSpeaker[] = [
  ...
  { id: 'aya', name: 'Aya Miyaguchi', title: 'Executive Director', company: 'Ethereum Foundation', color: '#d946ef', image: ayaImg, event: devcon7, companyLogo: logoEthereumFoundation },
  ...
  { id: 'hsiao', name: 'Hsiao-Wei Wang', title: 'Researcher', company: 'Ethereum Foundation', color: '#f43f5e', image: hsiaoImg, event: devcon6, companyLogo: logoEthereumFoundation },
