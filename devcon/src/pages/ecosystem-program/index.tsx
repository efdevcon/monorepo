...
import JaaliPattern from './jaali-left.svg'
import JaaliBottom from './jaali-bottom.svg'
import CommunityBannerBg from './community-banner.png'
import ArtOverlayText from './art-overlay-text.svg'
          ...
          <section id="ecosystem-needs" className={cn(css['overview-section'], css['scroll-anchor'])}>
              ...
              <div className={css['image-scroller']}>
                {SCROLLER_PHOTOS.map((photo, i) => (
                  <div key={i} className={css['scroller-item']}>
                    <Image src={photo} alt={`Ecosystem event photo ${i + 1}`} className={css['scroller-image']} fill sizes="455px" />
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className={css['text-section']}>
              ...
              <div className={css['body-block']}>
                ...
                <ul className={css['bullet-list']}>
                  ...
                  <li>
                    <strong>Promoting and putting into practice Ethereum&apos;s core values and CROPS</strong>:
                    Censorship Resistance, Open Source, Privacy, and Security, through hands-on experiences
                  </li>
                </ul>
              </div>
            </div>
              ...
              <div className={css['col']}>
                ...
                <div className={css['body']}>
                  <p style={{ marginBottom: 16 }}>
                    ...
                    <strong>hackathons</strong>, <strong>roundtables</strong>,{' '}
                    <strong>academic collaborations</strong>, and other formats that:
                  </p>
            ...
            <div id="apply" className={cn(css['budget-note'], css['scroll-anchor'])}>
              ...
              <p className={css['budget-note-footer']}>
                ...
                <br />
                Our contact:{' '}
                <a href="mailto:ecosystem@devcon.org">ecosystem@devcon.org</a>
              </p>
            </div>
          </section>
