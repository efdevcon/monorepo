---
overview:
  intro: "## **Overview**\n\n### Get your tickets through the following methods:\n\n->\_**Discounts - Application-based** (Closes Oct 29)\n\n->\_**General Admission sale waves** (Waitlist) – **$599 USD**\n\n<Buttons\n  Button={[\n    {\n      text: \"Apply For Discounts\",\n      url: \"#app-based\",\n      color: \"blue-1\",\n      fill: true\n    },\n    { text: \"Frequently Asked Questions\", url: \"#faq\", color: \"blue-1\" }\n  ]}\n/>\n"
  card: >
    ### **General Admission tickets available now!**


    General Admission tickets are first-come first-serve and are released in
    waves. **A wave is currently live.** See [timeline](#timeline) for more
    information.
...
raffle_auction:
  intro: >
    ...
    **[Head to the Raffle-Auction homepage to see if you won a
    ticket!](https://raffle.devcon.org/)**
  ...
  specs: >
    ...
    [here](https://tinyurl.com/yps8bdtw).
...
faq:
  - question: >-
      If I buy a ticket, and then I am accepted to Speak, can I get a refund for
      the original ticket I purchased?
    answer: >
      Yes! Speakers will be given a Free ticket — we will refund your original
      purchase.
  - question: >-
      If I am accepted for a discount after buying a full-priced ticket, can I
      get refund of the difference?
    answer: |
      Yes — we will do our best to refund the difference.
  - question: I need a Visa invitation Letter. How can I obtain one?
    answer: >
      You need a ticket before you can request a Visa Invitation Letter. Once
      you’ve purchased a ticket & have your Order ID ready, [request a Visa
      Invitation Letter here](https://forms.gle/fYhu45A9HUrbjYRr9)
  ...
  - question: What are the policies towards Refunds & Transfers?
    answer: >
      ...
      **All tickets will be refundable before the start of the event. You can cancel your own order by using the "Cancel Order" button at the bottom of your original order page.** Refunds will be issued using the same payment method
      ...
      **Transfers**
      ...
      [ticketing@devcon.org](mailto\:ticketing@devcon.org). PLEASE DO NOT
      ATTEMPT TO BUY OR SELL A TICKET FROM AN EXTERNAL SOURCE — YOU RISK BEING
      SCAMMED.
  - question: When tickets are sold out - How can I attend?
    answer: >
      ...
      [ticketing@devcon.org](mailto\:ticketing@devcon.org).
  - question: Will there be food to eat at the venue?
    answer: |
      Yes, all tickets include access to breakfast, lunch, and snacks all day.
_template: tickets
---
