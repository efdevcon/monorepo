...
community_led_sessions:
  ...
  sessions:
    - title: Test
      body: >
        ###### Community-led Sessions (CLS) are focused mini-events designed to
        make Devcon truly special by bringing together diverse fields and
        fostering interdisciplinary conversations. These sessions focus on
        topics that matter not just to Ethereum but to society as a whole.
      organizers: 'Weslaqeel, Mr Devcon, blalba, bla,blablab,b la'
      when: 'Day 4 - 14, NOv 2024'
      duration: FULL DAY
    - title: aaaabccc
      body: >
        ###### Community-led Sessions (CLS) are focused mini-events designed to
