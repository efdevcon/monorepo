...
index_ctas:
  - title: Apply to speak at Devcon —
    text: Speaker applications are open until July 30
    url: 'https://devcon.org/en/speaker-applications/'
  - title: Get your Devcon ticket now!
    text: 'Check if you''re eligible for a discount! '
    url: /tickets
  - title: Be a Devcon Supporter —
    text: Help fund vital Ethereum projects and gain access to Devcon for your team
    url: /supporters
section1:
  body: >
    ...
    **Devcon's mission is to bring decentralized protocols, tools, and culture
    to the world.**
    ...
    * -> is for the creators, thinkers, and makers who wish to improve this
    world through decentralization.
...
section3:
  body: >
    ...
    ### We want to help you bring your Ethereum community event or meetup in SEA
    to life!
