...
section1:
  body: >
    # Devcon is the Ethereum conference for developers, thinkers, and makers.
     ...
     Devcon is not only for developers. It’s a cultural hub of inspiration for passionate creators, researchers, community builders, and artists.

    Whether you're just starting or a seasoned Ethereum expert, Devcon is for
    you. Talks and workshops range from beginner to expert level.
section2:
  top: >
