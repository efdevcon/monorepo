...
section1:
  body: "# Devcon is the Ethereum conference for developers, thinkers, and makers.\n\nDevcon is not just for developers.\_Devcon is for the builders, creators, and thinkers who wish to improve this world through decentralization and using Ethereum. Content ranges from the deeply technological to the profoundly human.\n\n### **Why join Devcon?**\n\n* **Learn skills** relevant to Ethereum with the content best suited to you: talks, workshops, panels, or free-form discussions\n* Work and collaborate with** community leaders and experts**\n* Meet and socialize with the **entire Ethereum community**\n\n## Devcon's goal is to push the boundaries of the possible in our mission to bring decentralized protocols, tools, and culture to the world.\n"
section2:
  top: >
