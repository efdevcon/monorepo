...
overview:
  ...
  speaker_applications: >
    **There are many things to do at Devcon - check out the experiences page for
    a detailed overview.**


    <Buttons Button={[{ text: "Experiences", url: "/experiences" }]} />
  button:
...
faq:
  ...
  - question: When can I apply to speak at Devcon?
    answer: |
      Speaker applications are closed as of August 4
...
supporters_tickets: |
  <TwoColumns
    ...
    right={<>
      ...
      Update: All waves are sold out, but you can join the waiting list.
