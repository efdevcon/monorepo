  ...
  return (
    <div className={cn(cardClass, 'lg:py-4 col-start-1 col-end-4')}>
      ...
      <div className="flex gap-4 w-full bg-[#f4f2ff] justify-between px-4 py-3 border-bottom mb-4">
        <DaySchedule dayNumber={1} startTime="8:30 AM" endTime="8:00 PM" date={moment.utc('2024-11-12')} />
        <DaySchedule dayNumber={2} startTime="9:00 AM" endTime="8:00 PM" date={moment.utc('2024-11-13')} />
        <DaySchedule dayNumber={3} startTime="9:00 AM" endTime="8:00 PM" date={moment.utc('2024-11-14')} />
        <DaySchedule dayNumber={4} startTime="9:00 AM" endTime="8:00 PM" date={moment.utc('2024-11-15')} />
      </div>
