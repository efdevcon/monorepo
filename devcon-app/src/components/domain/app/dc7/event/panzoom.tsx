...
export const PanzoomControls = (props: { pz: PanZoom | null }) => {
  ...
  return (
    <div className={'absolute top-4 left-4 flex flex-col z-[1] gap-2 text-xs'}>
      {/* <CircleIcon className="bg-[#F0F2FF] w-[30px] h-[30px] pointer-events-auto" onClick={onClick}>
        <IconPlus id="zoomIn" style={{ fontSize: '18px', transform: 'rotateX(180deg)' }} />
      </CircleIcon>
      <CircleIcon className="bg-[#F0F2FF] w-[30px] h-[30px] pointer-events-auto" onClick={onClick}>
        <IconMinus id="zoomOut" style={{ fontSize: '18px', transform: 'rotateX(180deg)' }} />
      </CircleIcon> */}
      <div
        id="zoomIn"
        onClick={onClick}
