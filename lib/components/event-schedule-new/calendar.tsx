...
const NewSchedule = ({
  ...
  const getEventDateRange = (event: Event) => {
    ...
    if (earliestDate.toDateString() === latestDate.toDateString()) {
      ...
      return `${formatDate(earliestDate.toISOString())} - ${formatDate(
            ...
            <div className="p-4">
              ...
              <div className="mt-2 text-gray-600">
                ...
                {event.timeblocks.length > 0 && (
                  <p>
                    {formatTime(event.timeblocks[0].start)} -{" "}
                    {formatTime(event.timeblocks[0].end)}
              ...
              <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <p className="text-gray-700">
                    ...
                    {getEventDateRange(selectedEvent)}
                  </p>
                      ...
                      <ul className="mt-1 space-y-1">
                        {selectedEvent.timeblocks.map((block, index) => (
                          <li key={index} className="text-gray-600">
                            {formatDate(block.start)}: {formatTime(block.start)}{" "}
                  ...
                  <p className="text-gray-700">
                    <strong>Capacity:</strong> {selectedEvent.amountPeople}{" "}
                    people
                  </p>
                  <p className="text-gray-700">
