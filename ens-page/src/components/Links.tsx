    ...
    <div className="mt-6 space-y-3">
      {links.map(link => (
        <a
          ...
          className="relative flex min-h-14 items-center rounded-xl border border-neutral-200 bg-white px-14 py-2 text-center font-medium shadow-sm transition hover:-translate-y-0.5 hover:shadow-md"
        >
