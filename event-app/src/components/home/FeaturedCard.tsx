  ...
  return (
    <section>
      ...
      <a
        ...
        className="relative flex h-[208px] w-full flex-col justify-end overflow-hidden rounded-xl border border-dc-hairline p-4 transition-[scale,box-shadow] duration-150 ease-out hover:shadow-sm motion-safe:hover:scale-[1.03] motion-safe:active:scale-[0.97] lg:h-60 lg:max-w-[400px]"
      >
        ...
        <div className="absolute right-4 top-4 flex size-9 items-center justify-center rounded-full bg-white/20 shadow-[inset_0_0_1px_rgba(255,255,255,0.66)] backdrop-blur-[1.5px]">
