    ...
    <main className="py-6">
      ...
      <section className="relative mb-6 overflow-hidden rounded-2xl bg-[#3D00BF]">
        ...
        <div className="relative flex min-h-[220px] flex-col justify-end p-6 text-white">
          ...
          <InstallAppButton
            className="mt-4 inline-flex w-fit cursor-pointer items-center gap-2 rounded-full border border-white/30 bg-white/10 px-4 py-2 text-sm font-medium text-white backdrop-blur transition-colors hover:bg-white/20"
          />
        </div>
      </section>
