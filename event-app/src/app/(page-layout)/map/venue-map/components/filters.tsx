      ...
      <SwipeToScroll>
        <div
          className={cn(
            ...
            // Extend the masked scroll box so the open dropdown isn't clipped.
            // Mobile bar sits at the top → dropdown opens down (pad bottom).
            // Desktop bar sits at the bottom → dropdown opens up (pad top).
            openDropdown ? '!pb-[80vh] lg:!pb-2 lg:!pt-[80vh]' : ''
          )}
        >
            ...
            return (
              ...
              >
                ...
                {hasGroup && isOpen && (
                  <div
                    className={cn(
                      'absolute top-full mt-1 lg:top-auto lg:bottom-full lg:mt-0 lg:mb-1 bg-white rounded shadow-lg border border-gray-200 py-1 w-[fit-content] max-h-[300px] overflow-y-auto z-[1000000001]',
