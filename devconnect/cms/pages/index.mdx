...
event_calendar: >
  ...
  events.
what_is_devconnect: >-
  Devconnect Buenos Aires is now wrapped: a week that gathered more than 20,000
  participants from 130 countries, including 10,000+ Argentinians and 5,000+
  developers. With 79 exhibitors, 200 volunteers, and hundreds of events across
  the city, it marked the biggest Devconnect yet.
why_join_devconnect_arg_title: >-
  THE BEAUTIFUL CITY OF BUENOS AIRES HOSTED THE FIRST ETHEREUM WORLD’S FAIR FROM
...
ethereum_worlds_fair: >
  ### Over 14,000 attendees from 130+ countries gathered at the iconic La Rural
  in Palermo for a touch and feel experience on Ethereum.


  The first Ethereum World’s Fair brought over 80 exhibiting teams across eight
  dedicated districts for DeFi, Privacy, L2s, Decentralized Social, Hardware &
  Wallets, AI, Gaming, and Art. 


  The whole event was supported by more than 200 volunteers. Over 40 events took
  place inside La Rural, while 500+ community-run events took place across the
  city.
...
contribute_and_support_list:
  ...
  - title: Host a community event
    ...
    url: 'https://devconnect.org/calendar'
...
faq:
  ...
  - question: How do I get a visa invitation letter?
    answer: >
      Our special visa program with the Argentine Immigration Office is now
      closed (deadline Oct 17).
  ...
  - question: How do I get my app featured at the Ethereum World’s Fair?
    answer: >
      Applications are now closed. If you like to sponsor Devconnect, reach out
      to [supporters@devcon.org](mailto\:supporters@devcon.org).
  - question: How do I sponsor Devconnect?
    answer: >
      Please reach out to
      [supporters@devcon.org](mailto\:supporters@devcon.org).
  ...
  - question: >-
      ...
      calendar?
    answer: >
      Submit your event to our curated calendar here (pending our approval):
  ...
  - question: Have a different question or experiencing issues?
    answer: |
      Reach out to us at [support@devconnect.org](mailto\:support@devcon.org)
media_partners: >
  We're proud to have a great selection of media partners on board for
  Devconnect ARG. Check them out for stories about Ethereum, Devconnect speaker
  interviews, and more.
_template: index
---
