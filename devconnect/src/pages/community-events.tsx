                ...
                <div className="space-y-6 mt-6">
                  ...
                  <div className="flex flex-col gap-4">
                    <div className="border-t py-6 border-gray-300 border-b border-solid">
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-2">Tickets/signup URL</label>
                        <input
                          type="url"
                        ...
                        />
                        <p className="text-xs text-gray-500 mt-1">
                          URL where attendees can purchase tickets or sign up for the event
                        </p>
                      </div>
                    </div>
                  </div>
