          ...
          <div className="bg-white p-6 rounded-lg border border-solid border-gray-500 shadow-lg">
            ...
            <div className="mt-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Contact (Email, Twitter, etc.)</label>
                  <input
                    type="text"
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                          ...
                          <div>
                            ...
                            <input
                              ...
                              onChange={e => updateTimeslot(index, 'end_utc', formatDateTimeFromInput(e.target.value))}
                              className="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
                            />
